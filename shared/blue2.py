...
def config(parser):
    ...
    parser.add_argument(
        "meteo_dir", type=pathlib.Path, help="Path to meteo forcing files"
    )
    parser.add_argument(
        "--setup_dir",
        type=pathlib.Path,
    ...
    parser.add_argument(
        "--input_dir", type=pathlib.Path, help="Path to input files", default="Input"
    )
    parser.add_argument(
        "--output_dir", type=pathlib.Path, help="Path to save output files", default="."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        action="store_true",
        dest="debug_output",
        help="Do save additional fields to NetCDF",
    )
